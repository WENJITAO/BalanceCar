...
void drawbmp(u8 dat)
{
	switch(dat)
	{
		case 1 :OLED_DrawBMP(0,0,127,7,bmp1);break;
		case 2 :OLED_DrawBMP(0,0,127,7,bmp2);break;
	}
}
...
void OLED_Float(unsigned char X,unsigned char Y,double real,unsigned char N) 
{
   ...
   real_decimal=(unsigned int)(decimal*1e4);
...
void oled_txet(void)
{
    ...
    OLED_Float(0,2,Roll,1);  
    OLED_Float(0,4,Yaw,1);
	
    OLED_Float(40,0,gyrox,1);     
    OLED_Float(40,2,gyroy,1);  
    OLED_Float(40,4,gyroz,1);
	
    OLED_Float(80,0,aacx,1);     
    OLED_Float(80,2,aacy,1);  
    OLED_Float(80,4,aacz,1);
}

void oled_open_re(void)
{                                 //Ö÷Ò³Ãæ---ÏÔÊ¾½Ç¶È£¬Î»ÒÆ£¬µçÑ¹£¬×óÓÒ±àÂëÆ÷ËÙ¶È
    OLED_Float(70,0,Roll,1);     
    OLED_Float(70,2,speed_out,1);  
    OLED_Float(70,4,adc_read(),2);
	  OLED_Float(70,6,Long,1);
   // OLED_Float(40,6,Encoder_Left,1);
    //OLED_Float(90,6,Encoder_Right,1);
...
{  
 ...
 {                                      //µ÷²Î½çÃæ
      ...
      while(1)
      {   
        OLED_Float(50,2,erect_kp,1);   
        OLED_Float(90,2,erect_kd,1);
        OLED_Float(50,4,speed_Kp,1);  
        OLED_Float(90,4,MOD,1);
        OLED_Float(50,6,turn_kp,1);
        OLED_Float(90,6,turn_kd,1);
 ...
 while(adc_read()<0)
    {              
      ...
      {                              //ÏÔÊ¾¡°µçÁ¿²»×ãÇë³äµç¡±
         ...
         OLED_ShowCHinese(37,2,6);
         OLED_ShowCHinese(74,2,7);
         OLED_ShowCHinese(111,2,8);
         OLED_ShowCHinese(18,4,9);
         OLED_ShowCHinese(55,4,10);
         OLED_ShowCHinese(92,4,11);
      }
    }
}
